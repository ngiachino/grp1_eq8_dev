...
|US3|En tant qu’Utilisateur à partir de ma page d’acceuil, je veux pouvoir consulter un projet en cliquant dessus afin d’accéder aux différents aspects (issues, sprints, taches, releases, tests, documentations) de ce projet, et accéder à leur page correspondante.|HIGH|3|1|
|US4|En tant qu'Utilisateur je veux pouvoir revenir à ma page d’accueil afin d’avoir accès à ma liste de projets en cliquant sur un bouton présent sur chaque page|HIGH|1|2|
